            ...
            <div className="flex-1 mt-32 mb-24">
              <div className="flex flex-col max-w-screen-xl mx-auto px-4 sm:px-8">
                ...
                <div className="flex flex-col md:flex-row w-full md:space-x-4 space-y-4 md:space-y-0 mt-12">
                  <div className="flex flex-col w-full rounded-2xl shadow-sm px-2 p-4 md:p-8 bg-[#00260d] border-2 border-[#0bff72]">
                    <div className="text-md font-medium text-[#3ce068] text-center md:text-left">EigenLayer Points Earned</div>
                    <div className="text-sm text-[#6a9863] text-center md:text-left">
                      <span>Points will start accruing 24 hours after deposit</span>
                    </div>
                    <div className="flex gap-2 text-4xl text-[#54f591] mt-6 justify-center md:justify-start" style={{textShadow: "0px 0px 20px #0bff72"}}>
                      {formatNumber(Number(totalElPoints), 0)}
                      <span className="text-xl self-end">Pts</span>
                    </div>
                  </div>
                  <div className="flex flex-col w-full rounded-2xl shadow-sm px-2 p-4 md:p-8 bg-[#00260d] border-2 border-[#0bff72]">
                    <div className="text-md font-medium text-[#3ce068] text-center md:text-left">
                      Zero-G Points &nbsp;
                      <Tooltip>
                        {!isSubsquidLoading &&
                          subsquid &&
                ...
                <div className="flex flex-col gap-0.5 mt-4">
                  {/* Table Header */}
                  <div className="hidden md:grid grid-cols-5 rounded-xl gap-4 mb-0.5 px-6 py-4 bg-[#00260d] border-2 border-[#0bff72] text-[#3ce068]">
